 ...
 * the tinted per-element model, and starts the ambient particle sparkle
 * effect for activated crystals. Both are purely visual - neither mutates
 * any gameplay state, only reading NBT the server already wrote.
 * <p>
